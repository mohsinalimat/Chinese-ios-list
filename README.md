...
[![QQ 群](http://pub.idqqimg.com/wpa/images/group.png)](http://shang.qq.com/wpa/qunwpa?idkey=675c2a799269309290b11ae70c0835a88b35614a83f90c772e94a6219bef5bf5)


##### 关于
列表精选一些很棒的iOS框架，库，教程，Xcode插件，组件和更多。
该列表分为类别，如框架，组件，测试和其他，开源项目，免费和付费的服务。
排名不分先后，列表是github中各路大神供贡献的。
如果你想投稿，请阅读[guide](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md).

Swift 的项目将被标记 以 🔶  符号

AppleWatch 的项目将会用  ⌚ 标记


##### 怎么使用


由于列举的项目国语庞大,使用它们最好的方式就是加入我们一起探讨,共同学习

- [![QQ 群](http://pub.idqqimg.com/wpa/images/group.png)](http://shang.qq.com/wpa/qunwpa?idkey=675c2a799269309290b11ae70c0835a88b35614a83f90c772e94a6219bef5bf5)

- 只需 按下 <kbd>command</kbd> + <kbd>F</kbd> 去搜索关键词即可

- 通过我们的*内容菜单*

### 内容菜单

- [入门\开始](#getting-started)
- [开发库 和 框架](#libraries-and-frameworks)
    - [动画](#animation)
    - [Apple TV](#apple-tv)
    - [认证](#authentication)
    - [分析](#analytics)
    ...
    - [JSON](#json)
    - [Layout-自动布局](#layout)
    - [Localization-国际化语言适配](#localization)
    - [Logging  日志](#logging)
    - [地图](#maps)
    - [Math数学](#math)
    - [Media 多媒体](#media)
        ...
        - [PDF](#pdf)
        - [Video  视频](#video)
    - [Messaging- 即时通讯](#messaging)
    - [Machine Learning- 机器学习](#machine-learning)
    - [Networking  -网络](#networking)
    - [Push Notifications-推送](#push-notifications)
        - [Push Notification Providers - 推送提供商](#push-notification-providers)
    - [Passbook](#passbook)
    ...
    - [UI](#ui)
        ...
        - [Label](#label)
        - [Menu](#menu)
        - [Modal Transition -Modal 转场动画](#modal-transition)
        - [Popup](#popup)
        - [Pull to Refresh 下拉刷新](#pull-to-refresh)
        - [Rating Stars 评级五角星](#rating-stars)
        - [Slider 滑块](#slider)
        - [Stepper  步进](#stepper)
        - [Switch](#switch)
        - [Tab Bar](#tab-bar)
        ...
        - [Tag](#tag)
        - [TextField & TextView 文本框](#textfield--textview)
    - [Utility](#utility)
    - [VR](#vr)
...
- [Good Websites -网站推荐](#good-websites)
...
[熊才昌](https://github.com/xiongcaicahng) 意译,修改
